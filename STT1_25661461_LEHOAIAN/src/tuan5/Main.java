...
public class Main {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("|| 4. Tìm tiếm theo mã                                 ||");
    ...
    static void timTheoMa(CDList ql) {
        try {
            ...
            if (kq != null) {
                ...
                System.out.println("Không tìm thấy CD có mã " + ma);
            }
        } catch (NumberFormatException e) {
            System.out.println("Mã phải là số nguyên!");
        }
    ...
    static void timTheoTienTo(CDList ql) {
        System.out.print("Nhập từ khóa tiền tố (bên trái): ");
    ...
    static void timTheoHauTo(CDList ql) {
        System.out.print("Nhập từ khóa hậu tố (bên phải): ");
        String tk = sc.nextLine();
    ...
    static void timGanGiong(CDList ql) {
        System.out.print("Nhập từ khóa gần giống (chứa trong tựa): ");
        String tk = sc.nextLine();
